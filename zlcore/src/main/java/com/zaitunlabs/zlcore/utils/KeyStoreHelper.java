...
public class KeyStoreHelper {
    ...
    static void createKeysJBMR2(Context context, String alias) throws NoSuchProviderException,
        ...
        DebugUtil.logD(TAG, "Public Key is: " + kp.getPublic().toString());
    ...
    private static KeyStore.PrivateKeyEntry getPrivateKeyEntry(String alias) {
        try {
            ...
            if (entry == null) {
                DebugUtil.logW(TAG, "No key found under alias: " + alias);
                DebugUtil.logW(TAG, "Exiting signData()...");
                return null;
            }

            if (!(entry instanceof KeyStore.PrivateKeyEntry)) {
                DebugUtil.logW(TAG, "Not an instance of a PrivateKeyEntry");
                DebugUtil.logW(TAG, "Exiting signData()...");
                return null;
            }
