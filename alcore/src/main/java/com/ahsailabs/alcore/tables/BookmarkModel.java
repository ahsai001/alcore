...
public class BookmarkModel extends SQLiteWrapper.TableClass {
    ...
    public boolean hasSaved(){
        return SQLiteWrapper.of(AlCoreConstanta.DATABASE_NAME).count(null, BookmarkModel.class,"link = '"+link+"'", null) > 0;
    }

    public static BookmarkModel findBookmark(String link){
        return SQLiteWrapper.of(AlCoreConstanta.DATABASE_NAME).findFirstWithCriteria(null,BookmarkModel.class,
                "link = '"+link+"'", null);
    }
    ...
    public static List<BookmarkModel> getAllBookmarkList(){
        return SQLiteWrapper.of(AlCoreConstanta.DATABASE_NAME).findAll(null, BookmarkModel.class);
    }
